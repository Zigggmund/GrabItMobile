export const translations = {
  ru: {
    ...
    listingBookings: 'Бронирования по объявлению',
    ...
    systemBookingExpired: 'Заявка автоматически отменена',
    systemBookingActive: 'Аренда началась',
    systemBookingCompleted: 'Аренда завершена',
    systemBookingNoShow: 'Владелец отметил неявку',
    systemBookingExtensionRequested: 'Запрос на продление аренды',
    systemBookingExtended: 'Аренда продлена',
    systemBookingExtensionRejected: 'Продление аренды отклонено',
  ...
  en: {
    ...
    systemBookingExpired: 'Request auto-cancelled',
    systemBookingActive: 'Rental started',
    systemBookingCompleted: 'Rental completed',
    systemBookingNoShow: 'Owner marked no-show',
    systemBookingExtensionRequested: 'Extension requested',
    systemBookingExtended: 'Rental extended',
    systemBookingExtensionRejected: 'Extension rejected',
